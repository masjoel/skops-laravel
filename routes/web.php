...
Route::middleware(['auth.session'])->group(function () {
    ...
    */
    Route::prefix('master')->name('master.')->middleware(['role:administrator,operator'])->group(function () {
        ...
        Route::resource('murid', MuridController::class)->except(['index', 'show']);
        Route::get('murid', [MuridController::class, 'index'])->name('murid.index')->withoutMiddleware(['role:administrator,operator'])->middleware('role:administrator,operator,guru');
        Route::get('murid/{murid}', [MuridController::class, 'show'])->name('murid.show')->withoutMiddleware(['role:administrator,operator'])->middleware('role:administrator,operator,guru');
        ...
        Route::resource('walikelas', WaliKelasController::class)->except(['index', 'show']);
        Route::get('walikelas', [WaliKelasController::class, 'index'])->name('walikelas.index')->withoutMiddleware(['role:administrator,operator'])->middleware('role:administrator,operator,guru');
        Route::get('walikelas/{walikelas}', [WaliKelasController::class, 'show'])->name('walikelas.show')->withoutMiddleware(['role:administrator,operator'])->middleware('role:administrator,operator,guru');
        ...
        Route::resource('jenis-poin', JenisPoinController::class)->except(['index', 'show']);
        Route::get('jenis-poin', [JenisPoinController::class, 'index'])->name('jenis-poin.index')->withoutMiddleware(['role:administrator,operator'])->middleware('role:administrator,operator,guru');
        Route::get('jenis-poin/{jenis-poin}', [JenisPoinController::class, 'show'])->name('jenis-poin.show')->withoutMiddleware(['role:administrator,operator'])->middleware('role:administrator,operator,guru');
