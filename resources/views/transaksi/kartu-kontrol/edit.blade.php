    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-5">
            <div class="card bg-light">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('transaksi.kartu-kontrol.update', $kartuKontrol->id) }}">
                        @csrf @method('PUT')
                        <div class="row">
                            ...
                            <div class="col-md-8 mb-3">
                                ...
                                <select name="periode_akademik_id"
                                    ...
                                    @foreach ($periodeAkademikList as $pa)
                                        <option value="{{ $pa->id }}"
                                            {{ old('periode_akademik_id', $kartuKontrol->periode_akademik_id) == $pa->id ? 'selected' : '' }}>
                        ...
                        @if (auth()->user()->role == 'guru')
                            <input type="hidden" name="guru_id" value="{{ $kartuKontrol->guru_id }}">
                        @else
                            <div class="mb-3">
                                <label class="form-label">Guru</label>
                                @php
                                    $selectedGuruId = old('guru_id', $kartuKontrol->guru_id);
                                    $selectedGuruName = '';
                                    if ($selectedGuruId) {
                        ...
                        <div class="mb-3">
                            ...
                            @php
                                $selectedMuridKelasId = old('murid_kelas_id', $kartuKontrol->murid_kelas_id);
                        ...
                        <div class="row">
                            <div class="col-md-9 mb-3">
                                ...
                                @php
                                    $selectedJenisPoinId = old('jenis_poin_id', $kartuKontrol->jenis_poin_id);
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="tindakan" rows="2" class="form-control @error('tindakan') is-invalid @enderror"
                                placeholder="Contoh: Dipanggil BK, diberi peringatan tertulis, dsb.">{{ old('tindakan', $kartuKontrol->tindakan) }}</textarea>
                            @error('tindakan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
