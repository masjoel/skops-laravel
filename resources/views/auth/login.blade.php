...
<style>
    ...
    .brand-desc { color: #94a3b8; font-size: 16px; line-height: 1.7; max-width: 380px; margin-bottom: 48px; }
    ...
    @media(min-width: 992px){ .auth-right { min-height: 100vh; } }
    ...
    .login-title { font-size: 22px; font-weight: 700; color: #f8fafc; margin-bottom: 6px; }
    .login-sub { color: #64748b; font-size: 13.5px; }
    .company-name { color: #818cf8; font-weight: 600; }

    .form-group { margin-bottom: 18px; }
    .form-label-auth { font-size: 13px; font-weight: 500; color: #94a3b8; margin-bottom: 8px; display: block; }
    ...
    .error-text { font-size: 12px; color: #f87171; margin-top: 6px; display: block; }
    ...
    .btn-login:hover { opacity: .9; transform: translateY(-1px); box-shadow: 0 6px 20px rgba(99,102,241,.5); }
    ...
    .login-footer a { color: #818cf8; text-decoration: none; }
</style>
...
<div class="auth-wrapper">
    ...
    <div class="auth-left">
        ...
        <div class="brand-name">
            Super<span>store</span><br>Management
        </div>
        <p class="brand-desc">
            Sistem manajemen toko terpadu — kelola stok, penjualan, pembelian, dan keuangan dalam satu platform.
        </p>
        <div class="feature-list">
            <div class="feature-item">
                <div class="feature-icon"><i class="fas fa-boxes"></i></div>
                <div class="feature-text">Manajemen stok barang real-time dengan notifikasi stok kritis</div>
            </div>
            <div class="feature-item">
                <div class="feature-icon"><i class="fas fa-shopping-cart"></i></div>
                <div class="feature-text">Transaksi penjualan & pembelian dengan cetak faktur otomatis</div>
            </div>
            <div class="feature-item">
                <div class="feature-icon"><i class="fas fa-chart-line"></i></div>
                <div class="feature-text">Laporan keuangan dan grafik omset bulanan yang informatif</div>
            </div>
        </div>
    </div>
    ...
    <div class="auth-right">
        <div class="login-card">
            ...
            <div class="login-footer">
                &copy; {{ date('Y') }} Superstore Management System
            </div>
        </div>
    </div>
</div>
