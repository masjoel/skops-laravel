                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" id="username" name="username" class="form-input"
                                placeholder="Masukkan username" value="{{ old('username', 'demo') }}" autocomplete="username"
                                autofocus required>
                        </div>
                        @error('username')
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" id="password" name="password" class="form-input"
                                placeholder="Masukkan password" autocomplete="current-password"  value="demo" required>
