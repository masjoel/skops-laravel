...
@section('content')
    <div class="page-header">
        ...
        <a href="{{ route('master.jurusan.index') }}" class="btn btn-outline-secondary"><i
                class="fas fa-arrow-left me-2"></i>Kembali</a>
    </div>
    <div class="row justify-content-center">
        <div class="col-12 col-md-5">
            <div class="card bg-light">
                <div class="card-header"><i class="fas fa-ruler me-2" style="color:#6366f1"></i>Form Tambah {{ $title }}
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('master.jurusan.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="kode" class="form-control @error('kode') is-invalid @enderror"
                                value="{{ old('kode') }}" oninput="this.value = this.value.toUpperCase();" placeholder="Contoh: IPA, RPL, TKJ">
                            @error('kode')
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('master.jurusan.index') }}" class="btn btn-outline-secondary flex-fill"><i
