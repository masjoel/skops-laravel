...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .sidebar-brand-sub { font-size: 11px; color: var(--sidebar-text); font-weight: 400; }
        ...
        .sidebar-footer-name { font-size: 13px; font-weight: 600; color: #f8fafc; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
        ...
        .btn-sidebar-toggle:hover { background: var(--border-color); color: var(--text-main); }
...
<nav id="sidebar">
    ...
    <div class="sidebar-nav">
        ...
        {{-- <a href="{{ route('master.kelas-ekstensi.index') }}"
           class="nav-item-link {{ request()->routeIs('master.kelas-ekstensi.*') ? 'active' : '' }}">
...
<header id="topbar">
    ...
    <div class="topbar-right">
        ...
        <a href="{{ route('master.barang.index') }}" class="topbar-btn" title="Stok Kritis: {{ session('brgpend') }} item">
...
<div id="main-wrapper">
    <main id="main-content">
        {{-- Flash Messages --}}
        @if(session('success'))
            <div class="alert alert-success alert-dismissible fade show d-flex align-items-center gap-2 mb-3" role="alert" style="border-radius:10px;border:none;background:rgba(34,197,94,.12);color:#16a34a">
        ...
        @endif
        @if(session('error'))
            <div class="alert alert-danger alert-dismissible fade show d-flex align-items-center gap-2 mb-3" role="alert" style="border-radius:10px;border:none;background:rgba(239,68,68,.12);color:#dc2626">
        ...
        @endif
        @if($errors->any())
            <div class="alert alert-danger alert-dismissible fade show mb-3" style="border-radius:10px;border:none;background:rgba(239,68,68,.12);color:#dc2626">
                ...
                <button type="button" class="btn-close ms-auto position-absolute top-0 end-0 m-2" data-bs-dismiss="alert"></button>
            </div>
        @endif
